...
echo -e "allow_other,rw,async_read=false,use_ino,func.getattr=newest,category.action=all,category.create=ff,cache.files=auto-full,dropcacheonclose=true,nonempty,minfreespace=0,fsname=mergerfs" >> /tmp/mergerfs_mount_file
